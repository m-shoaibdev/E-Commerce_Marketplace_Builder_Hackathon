        ...
        <div className="lg:container lg:mx-auto px-4 lg:px-10 flex justify-between items-center">
          <Link href="/">
            <Image
              src={Logo}
              alt="logo"
              className="w-36 sm:w-40 md:w-[165px] h-auto "
            />
          </Link>
          <Link
            href={"/cart"}
            className="flex gap-2 items-center bg-white py-2.5 px-4 text-13 hover:text-primary"
          >
            <svg
              className="size-5 "
              viewBox="0 0 20 19"
            ...
            Cart
            <div className="bg-primaryHover text-white text-[10px] px-2 py-1 rounded-full ml-0.5">
              2
            </div>
          </Link>
        </div>
